    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#2C2016] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        ...
        <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed mb-12 space-y-6">
          ...
          <p>Dengan membuat akun dan menggunakan layanan Hubify Social ("Layanan"), Anda menyetujui semua persyaratan yang tercantum dalam Terms of Service ini. Jika Anda tidak setuju, mohon untuk tidak menggunakan layanan kami.</p>

          <h2 className="text-2xl font-bold text-[#0B2A4A] mt-8 mb-4">2. Deskripsi Layanan</h2>
          <p>Hubify Social adalah platform manajemen media sosial komprehensif yang menyediakan fitur kalender multi-view, asisten AI (Artificial Intelligence) untuk copywriting dan ideasi, integrasi platform, dan fitur analitik terkait kinerja konten.</p>
          ...
          <p>Hubify Social menawarkan paket gratis (Trial) dan paket berbayar bulanan serta tahunan. Layanan akan otomatis berlanjut mengikuti siklus berlangganan yang Anda pilih kecuali jika Anda membatalkannya sebelum tanggal jatuh tempo berikutnya. Hubify Social tidak melayani pengembalian dana prorata apabila Anda membatalkan di tengah periode aktif berlangganan.</p>

          <h2 className="text-2xl font-bold text-[#0B2A4A] mt-8 mb-4">6. Pemutusan Layanan</h2>
          <p>Kami berhak memblokir, menangguhkan, maupun menghapus akun pengguna tanpa pemberitahuan sebelumnya jika terindikasi adanya pelanggaran yang membahayakan reputasi atau infrastruktur Hubify Social, termasuk melakukan tindakan scraping tidak wajar atau pelanggaran sistematis dari Aturan Layanan ini.</p>
        </div>
      </main>
      <PublicFooter />
    </div>
