...
export function UserProfile({
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const finalReason =
        deleteReason === "Lainnya" ? customReason : deleteReason;
      ...
      if (e.code === "auth/requires-recent-login") {
        ...
        setMessage({
          text: "Gagal menghapus akun: " + e.message,
          type: "error",
        });
      }
    } finally {
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      if (cleanUsername.length < 3 || cleanUsername.length > 20) {
        throw new Error(
          "Username harus antara 3 - 20 karakter dan hanya boleh berisi huruf, angka, atau underscore.",
        );
      }
      ...
      if (cleanUsername !== userProfile.username) {
        await runTransaction(db, async (t) => {
          ...
          t.update(doc(db, "users", userProfile.uid), {
            fullName: name,
  ...
  const handleChangePassword = async () => {
    if (!newPass)
      return setMessage({ text: "Masukkan password baru", type: "error" });
    if (hasPasswordProvider && !oldPass)
      return setMessage({ text: "Masukkan password lama", type: "error" });
    setLoading(true);
    try {
    ...
    >
        ...
        >
          <div
            style={{
              ...
              fontSize: 32,
              fontWeight: 600,
              boxShadow: "0 10px 30px var(--theme-primary)33",
              overflow: "hidden",
          ...
          <div
            style={{
              ...
              bottom: -6,
              right: -6,
              background: "var(--theme-text-main, #2C2016)",
              color: "white",
              width: 24,
              height: 24,
              borderRadius: 12,
              ...
              style={{
                background:
                  userProfile?.plan === "vip"
                    ? "#FBC02D"
                    : userProfile?.activeUntil &&
                        new Date(userProfile.activeUntil) > new Date()
                      ? "var(--theme-primary)"
                      : "#9C2B4E",
      ...
      {message.text && (
        <div
          style={{
            padding: 16,
            borderRadius: 12,
            background: message.type === "success" ? "#E5F4EE" : "#F8EAF0",
            color: message.type === "success" ? "#2D7A5E" : "#9C2B4E",
            fontSize: 14,
            fontWeight: 600,
          }}
        >
      ...
      >
        ...
        <div style={CARD({ gridColumn: "span 2" })}>
          ...
          >
            <Sparkles size={18} color="var(--theme-primary)" /> Penggunaan
            HUB.AI
          </h3>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              >
                Permintaan Dikeluarkan (Hari Ini)
              </span>
              <span
                style={{
                  fontSize: 13,
              ...
              >
                {(() => {
                  const maxReq =
                    userProfile?.plan === "pro" || userProfile?.plan === "vip"
                      ? 10
                      : 5;
                  const todayStr = new Date().toISOString().split("T")[0];
                  const usedReq =
                    userProfile?.lastAiRequestDate === todayStr
                      ? userProfile?.aiRequestsToday || 0
                      : 0;
            ...
            >
              Setiap interaksi dengan HUB.AI (tanya jawab, buat konten, dsb)
              dihitung sebagai 1 permintaan. Kuota akan otomatis di-reset setiap
              harinya.
            </p>
          </div>
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              ...
              <input
                ...
                style={I({ background: !isEditing ? "#F5F5F5" : "white" })}
              />
            </div>
            <div>
              <label
        ...
        <div style={CARD()}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div
              style={{ padding: 12, borderRadius: 12, background: "#F5F5F5" }}
            >
              ...
              {auth.currentUser?.emailVerified ? (
                <div
                  style={{ color: "#2D7A5E", fontSize: 13, fontWeight: 600 }}
                >
                  ✅ Terverifikasi
                </div>
              ) : (
                <div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    style={{ ...B(false), fontSize: 11, padding: "6px 12px" }}
                  >
                    Kirim Ulang Link Verifikasi
                  </button>
                  {emailStatusMsg && (
                    <div
                      style={{ fontSize: 11, color: "#2D7A5E", marginTop: 8 }}
                    >
                      {emailStatusMsg}
                    </div>
                  )}
            ...
            <div>
              {hasPasswordProvider ? (
                ...
                >
                  Anda belum menyetel password (login via Google). Buat password
                  sekarang.
                </div>
              )}
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button
                  ...
                  disabled={
                    !newPass || (hasPasswordProvider && !oldPass) || loading
                  }
                  style={{
                    ...B(!!newPass && (!hasPasswordProvider || !!oldPass)),
                    whiteSpace: "nowrap",
                  }}
                >
        ...
        <div style={CARD({ gridColumn: "span 2" })}>
          ...
          >
            <div>
              ...
              >
                Workspace Aktif: {activeWorkspace?.name || "Personal Workspace"}
              </p>
              <p style={{ fontSize: 12, color: "rgba(44,32,22,0.5)" }}>
                Anda adalah Owner dari workspace ini.
              </p>
            </div>
            <button
            ...
            >
              Upgrade / Ganti Plan <ChevronRight size={14} />
            </button>
          </div>
          ...
          >
            ...
            >
              Hapus akun Anda secara permanen beserta semua data yang ada di
              dalamnya.
            </p>
            <button
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Semua data ruang kerja,
              tiket, dan transaksi akan terhapus.
            </p>
            <div style={{ marginBottom: 16 }}>
              ...
              <select
                ...
                style={{ ...I({}), width: "100%", marginBottom: 12 }}
              >
                    ...
                    <div>
                      ...
                      <div
                        style={{
                          fontSize: 11,
                          background:
                            tx.status === "success" ? "#E5F4EE" : "#F8EAF0",
                          color:
                            tx.status === "success" ? "#2D7A5E" : "#9C2B4E",
                          padding: "2px 8px",
                          borderRadius: 4,
